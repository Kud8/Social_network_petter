...
class Pet(models.Model):
    author = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=u'Хозяин', related_name='Питомец')
    date_created = models.DateTimeField(verbose_name=u'Дата появления', auto_now_add=True)
    birthday = models.DateTimeField(verbose_name=u'Дата рождения', auto_now_add=True)
